...
Use Python 3. No additional packages are required. Run commands from the folder
containing this README and the Python files. Use `python` instead of `python3`
if that is how Python 3 is configured on your computer.
...
Submit your written responses and the three completed `*_practice.py` files.
